...
def main():
    ...
    tab_overview, tab_data, tab_generate, tab_settings, tab_help = st.tabs(
        ["Overview", "Data & RAG", "Generate Worksheets", "Settings", "Help"]
    )
...
**File upload**
- Instructions for uploading student CSV files and optional curriculum bank files to enable Retrieval-Augmented Generation (RAG).

**Worksheet generation**
- Step-by-step explanation of how personalised worksheets are generated based on student performance levels.
